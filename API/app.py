...
# =====================================================================
# MOTOR PPK HÍBRIDO DETERMINISTA (VERSIÓN 8)
# =====================================================================
def aislar_diferencias_simples_ppk(obs_b, obs_r):
    ...
    for tow in sorted(list(obs_r.keys())):
        ...
        for s, d_r in obs_r[tow].items():
            ...
            # [VERSIÓN 8]: Extracción de frecuencia física determinista
            if d_b.get('C1') and d_r.get('C1'):
                pr_b, pr_r = d_b['C1'], d_r['C1']
                cp_b, cp_r = d_b.get('L1'), d_r.get('L1')
                wave_sys = WAVE_L1
            elif d_b.get('C5') and d_r.get('C5'):
    ...
    def procesar():
        try:
            ...
            for nivel in range(p_iter):
                            ...
                            for cp in set(cp_grid):
                                for ca in set(ca_grid):
                                    ...
                                    if score < nivel_best_rmse:
                                        ...
                                        # [VERSIÓN 8]: Lógica Global Definitiva. Solo reescribe si el terreno encontrado es ABSOLUTAMENTE mejor.
                ...
                # [VERSIÓN 8]: Centramos el próximo zoom en la mejor coordenada histórica, evitando perdernos si un nivel completo falla.
